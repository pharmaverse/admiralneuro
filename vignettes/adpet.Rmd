...
Tau PET scan data generally do not require any further derivations, and the conversion of tau SUVR to CenTauR will be available in the next release (0.2.0) of this package.
...
In the following steps, we will incorporate the **conversion** from **amyloid SUVR to Centiloid** using
