...
Tau PET scan data do not require any further derivation.
Therefore, only a selection of the corresponding Tau tracer records is necessary.
...
To that end, we will select the Amyloid tracer records from the global PET Scan Analysis Dataset (`adpet`),
for which the parameter-level and analysis value variables have already been created.
