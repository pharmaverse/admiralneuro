...
adpet_param <- distinct(adpet, USUBJID, NVTESTCD, NVCAT, NVLOC, PARAMCD, PARAM, PARAMN)
dataset_vignette(adpet_param, display_vars = exprs(USUBJID, NVTESTCD, NVCAT, NVLOC, PARAMCD, PARAM, PARAMN))
```
